...
{ 
  ...
  SPI1_Init();  
	...
	SPI1_SetSpeed(SPI_SPEED_4);		//设置为50M时钟,高速模式 
	W25QXX_TYPE=W25QXX_ReadID();	//读取FLASH ID.
    if(W25QXX_TYPE==W25Q512)        //SPI FLASH为W25Q512
    {
...
{ 
 	u16 i;   										    
	W25QXX_CS(0);                           //使能器件   
    SPI1_ReadWriteByte(W25X_FastReadData);	//发送快速读取命令（SPI CLK可以高达104Mhz）  
    if(W25QXX_TYPE==W25Q512)                //如果是W25Q256的话地址为4字节的，要发送最高8位
    {
